...
url: 'https://instagram/xyyz_nomercy.com'
}
}, {
quickReplyButton: {
...
urlButton: {
displayText: 'Group Whatsapp',
url: 'https://chat.whatsapp.com/LjK0gR347JcEkZt2LEiOoj'
}
}, {
quickReplyButton: {
displayText: 'Status Bot',
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© 𝚉𝚁𝙸𝙻𝙻𝙱𝙾𝚃𝚉", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© 𝚉𝚁𝙸𝙻𝙻𝙱𝙾𝚃𝚉", log0, btn, thum)
}
